            ...
            <Col
                ...
                <Panel>
                    <Well>
                        ...
                        <Row className="text-center">
                            <Col xs={4} xsOffset={4}><Button bsSize="large" bsStyle="info" onClick={(event) => this.enterId(event)} value="0">0</Button></Col>
                        </Row>
                        <Row className="text-center">
                            <Col xs={4}><Button bsSize="large" bsStyle="success" onClick={() => this.userCheck()}>Login</Button></Col>
                            <Col xs={4} xsOffset={4}><Button bsSize="large" bsStyle="danger" onClick={() => this.deleteChar()}>Delete</Button></Col>
                        </Row>
                    </Well>
                </Panel>
            </Col>
